...
/**
 * Dashboard stats repository — admin stats core + client stats.
 *
 ...
 *
 * **PR-B.3 refactor (abril 2026)**: agregaciones cross-model del dashboard
 * admin fueron movidas a read-models por dominio en `queries/`:
 *   - `FinancialQueriesRepository` — revenue, collections, plan launch
 *   - `OperationalQueriesRepository` — technical inspections, professionals, inactive clients
 *   - `PortfolioQueriesRepository` — ISV del stock, certificados
 *
 * Esta clase mantiene solo lo core (admin counts, client stats, recent
 * activity, property/plan linkages) para no volver a ser un God Object.
 */
@Injectable()
