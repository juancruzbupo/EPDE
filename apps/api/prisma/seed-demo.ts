...
export async function seedDemo(prisma: PrismaClient) {
  ...
  const lauraProp = await prisma.property.create({
    data: {
      id: ids.lauraProp,
      userId: laura.id,
      address: 'Barrio San Agustín, Calle Los Ceibos 430',
      city: 'Paraná',
      type: 'HOUSE',
      yearBuilt: 2023,
      squareMeters: 150,
      ...
      items: {
        create: [
          { sector: 'ROOF', name: 'Cubierta y canaletas', status: 'OK', order: 0 },
          {
            ...
            status: 'NEEDS_ATTENTION',
            order: 1,
            finding: 'Tablero antiguo, recomendable actualizar protecciones en 12 meses',
          },
        ...
        create: [
          {
            ...
            status: 'NEEDS_PROFESSIONAL',
            order: 0,
            finding: 'Disyuntor ausente, cables sin protección térmica adecuada',
          },
          {
            sector: 'INTERIOR',
            ...
            status: 'NEEDS_PROFESSIONAL',
            order: 1,
            finding: 'Filtración activa desde piso superior',
          },
          { sector: 'EXTERIOR', name: 'Fachada', status: 'NEEDS_ATTENTION', order: 2 },
        ],
      },
    },
  });
