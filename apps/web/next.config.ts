...
const nextConfig: NextConfig = {
  images: {
    remotePatterns: [
      ...
      { protocol: 'https', hostname: '**.epde.com.ar' },
    ],
  },
  ...
  headers: async () => [
    {
      ...
      headers: [
        ...
        { key: 'Strict-Transport-Security', value: 'max-age=31536000; includeSubDomains' },
        {
          ...
          // emits inline hydration scripts and CSS-in-JS. 'unsafe-eval' is required in
          // development for HMR/Fast Refresh but stripped in production builds.
