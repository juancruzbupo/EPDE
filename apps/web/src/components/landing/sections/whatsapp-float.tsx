 ...
 *
 * Desktop-only a partir de abril 2026: en mobile la `MobileStickyCta`
 * cubre el mismo intent con un botón full-width que convierte mejor que
 * el FAB redondo. Se mantiene en md+ porque el sticky bar no aparece
 * ahí (el header ya tiene CTA primario siempre visible en desktop).
 */
export function WhatsAppFloat() {
  return (
    ...
    >
      ...
      <span className="text-sm font-medium text-white">Hablar por WhatsApp</span>
    </a>
  );
}
