...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed right-4 bottom-20 z-50 flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-3 shadow-lg transition-colors hover:bg-[#20BD5A] md:bottom-6"
    >
