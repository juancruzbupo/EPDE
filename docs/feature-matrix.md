...
| Tareas próximas                            |     ❌      |      ✅       |        ✅        |                 ❌                 |                                                                                     |
| Card revenue consolidado (admin)           |     ✅      |      ❌       |        ❌        |                 ❌                 | Plan + informes técnicos, delta mes vs anterior, YTD. Cached 5 min                  |
| Card cobranza pendiente (admin)            |     ✅      |      ❌       |        ❌        |                 ❌                 | Informes REPORT_READY sin pago + suscripciones vencidas/por vencer                  |
| Card inspecciones técnicas (admin)         |     ✅      |      ❌       |        ❌        |                 ❌                 | Estados + warning cobranza + mix por tipo                                           |
| Card launch tracking (admin)               |     ✅      |      ❌       |        ❌        |                 ❌                 | X/20 clientes + mix tier + warning al acercarse                                     |
| Card ISV del portfolio (admin)             |     ✅      |      ❌       |        ❌        |                 ❌                 | Promedio + distribución 4 buckets + trend + certificables                           |
| Card operación & retención (admin)         |     ✅      |      ❌       |        ❌        |                 ❌                 | Certificados + profesionales (matrículas, pagos, top 3) + clientes en riesgo        |
| Ciclo operativo inspecciones (tab)         |     ✅      |      ❌       |        ❌        |                 ❌                 | Días por tramo del state machine (agendar/ejecutar/cobrar)                          |
| **Propiedades**                            |             |               |                  |                                    |                                                                                     |
| Listado                                    |     ✅      |      ✅       |        ✅        |                 ✅                 |                                                                                     |
...
| Directorio CRUD (19 especialidades AR)     |     ✅      |      ❌       |        ❌        |                 ❌                 | /professionals. Admin-only, gated por middleware. 19 specialties (ADR-018)          |
| Smart match top-3 para SRs                 |     ✅      |      ❌       |        ❌        |                 ❌                 | Tier + rating bayesiano + anti-fatiga                                               |
| Cobertura de especialidades (CoverageCard) |     ✅      |      ❌       |        ❌        |                 ❌                 | Barra de progreso 0/19 con gaps por tier. Alerta si falta Tier 1 (plomero/gas/elec) |
...
| **Plan EPDE (launch pricing)**             |             |               |                  |                                    |                                                                                     |
| Tiers por superficie ($55k/$75k/$110k)     |     N/A     |      ✅       |        ❌        |                 ❌                 | PLAN_PRICE_TIERS en landing-data.ts; snapshot en MaintenancePlan.priceTier          |
| Launch banner "primeros 20 clientes"       |     N/A     |      ✅       |        ❌        |                 ❌                 | Target hardcoded; admin ve progreso en launch-tracking-card                         |
| Revenue tracking por tier (admin)          |     ✅      |      ❌       |        ❌        |                 ❌                 | Breakdown SMALL/MEDIUM/LARGE + precio promedio efectivo                             |
| **Suscripción**                            |             |               |                  |                                    |                                                                                     |
