...
| `TASK_STATUS_ORDER`       | Tareas    | Orden de display: OVERDUE, PENDING, UPCOMING (COMPLETED excluido — tareas nunca permanecen en ese estado) |
...
| Badge        | `components/ui/badge.tsx`         | Variantes: default, secondary, outline, destructive, success, warning |
